...
const TABS = [
  ...
  { id: "services", label: "Services", icon: Wrench,   to: "/services/seamless-gutter-installation/", match: (p) => p.startsWith("/services") },
  ...
  return (
    <nav
      ...
      style={{
        ...
        boxShadow: "0 -1px 0 0 oklch(0.44 0.16 250 / 0.10)",
      }}
      aria-label="Primary"
    >
