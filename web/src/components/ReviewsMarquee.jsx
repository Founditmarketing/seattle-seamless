  ...
  return (
    ...
    >
      ...
      <div className="max-w-[var(--max-content)] mx-auto px-[var(--space-page-x)] mt-8 lg:mt-10 text-[12px] text-[var(--color-slate)]/55 text-center lg:text-left">
        Verified Google reviews · never edited, never paid for.
      </div>
    </section>
  );
}
