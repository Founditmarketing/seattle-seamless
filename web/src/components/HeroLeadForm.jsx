...
const SERVED_PREFIXES = new Set(["980", "981", "982", "983", "984", "985", "988"]);
    ...
    <div className="material-light w-full lg:max-w-md rounded-[var(--radius-tile)] shadow-[0_24px_60px_-20px_rgba(0,0,0,0.55)] border border-white/10 overflow-hidden">
      {step === 0 && (
        <form onSubmit={handleZipSubmit} className="p-5 sm:p-6 lg:p-7">
          ...
          <h2 className="font-display text-[var(--color-royal)] text-[22px] sm:text-2xl lg:text-[28px] font-light leading-[1.15] mb-4 sm:mb-5">
            Service Areas.
          </h2>
      ...
      {step === 1 && (
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 lg:p-7">
          ...
          {/* Email — required so Doug has a written-quote channel and a
          ...
          {/* Property address. ZIP was already collected in step 0; we
              still ask for street + city so Doug can route the crew. */}
          <input
            id="address"
            name="address"
            type="text"
