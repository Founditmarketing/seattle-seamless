...
const TRUST_PILLS = [
  { icon: Star,   label: `${SITE.rating.value.toFixed(1)} ★ Google` },
    ...
    >
      ...
      <div ref={parallaxRef} className="absolute inset-0 -z-0 will-change-transform">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(closest-side, oklch(0.72 0.11 42 / 0.42) 0%, oklch(0.72 0.11 42 / 0.18) 35%, transparent 70%)",
            filter: "blur(40px)",
          }}
          aria-hidden
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(closest-side, oklch(0.44 0.16 250 / 0.45) 0%, oklch(0.44 0.16 250 / 0.12) 45%, transparent 75%)",
            filter: "blur(60px)",
          }}
          aria-hidden
        />
        ...
        <div
          ...
          style={{
            background:
              "conic-gradient(from 200deg at 50% 50%, transparent 0deg, oklch(0.72 0.11 42 / 0.6) 60deg, transparent 140deg)",
            filter: "blur(80px)",
          }}
          aria-hidden
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, transparent 0%, oklch(0.19 0.09 250 / 0.55) 60%, oklch(0.19 0.09 250 / 0.92) 100%)",
          }}
          aria-hidden
        />
          ...
          <div className="lg:col-span-7">
            ...
            >
              <span className="md:hidden">
                <span className="mob-hero-word inline-block">Built</span>{" "}
                <span className="mob-hero-word inline-block">for</span>{" "}
                <span className="mob-hero-word inline-block">the</span>
                <br />
                <span className="mob-hero-word inline-block text-[var(--color-copper)]">Puget Sound.</span>
              </span>
              <span className="hidden md:inline">
                Built for the
                <br />
                <span className="text-[var(--color-copper)]">Puget Sound.</span>
              </span>
            </h1>
            ...
            >
              Seamless aluminum gutters. Custom made on your property,
              installed the same day. Same-week estimates in Pierce, King, Thurston, Kitsap, Snohomish, and Mason counties.
            </p>
