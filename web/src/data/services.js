import { Hammer, Wrench, Shield, Home, Sparkles } from "lucide-react";
...
export const SERVICES = [
  ...
  },
  {
    ...
    short: "Annual cleanouts before fall and after spring needle drop.",
    desc:
      "Annual cleanouts before fall and after spring needle drop. We hand-clear, flush, and inspect downspouts on every visit.",
    image: "service-cleaning-real",
    photoAlt:
      "Seamless Gutters 4 Less worker on a ladder inspecting and cleaning gutters on a residential home.",
  },
];
